...
| `claude-computer/r2`                 | Login       | username = access key ID · password = secret access key · custom fields `endpoint` (`https://<account-id>.r2.cloudflarestorage.com`), `bucket` | `archive-*`, `camera-ingest`, `library-push`, `resources-sync` |
